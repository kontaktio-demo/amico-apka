...
const KATEGORIA_PRESET: Record<ProduktKategoria, StonePreset> = {
  marmur: { base: '#f2efe9', base2: '#e6e1d7', vein: '#a9a294', freqX: 0.012, freqY: 0.05, octaves: 5, kontrast: 0.55, polysk: 0.5 },
  granit: { base: '#3c3d42', base2: '#2b2c31', vein: '#5a5c63', freqX: 0.85, freqY: 0.85, octaves: 2, kontrast: 0.7, polysk: 0.35 },
  kwarc: { base: '#edeae4', base2: '#e2ded6', vein: '#c3bdb2', freqX: 1.1, freqY: 1.1, octaves: 2, kontrast: 0.3, polysk: 0.4 },
  konglomerat: { base: '#ecebe7', base2: '#dedcd5', vein: '#c0bcb2', freqX: 1.2, freqY: 1.2, octaves: 2, kontrast: 0.32, polysk: 0.45 },
  spiek: { base: '#d7d7d8', base2: '#c7c7c9', vein: '#a9a9ac', freqX: 0.6, freqY: 0.6, octaves: 2, kontrast: 0.28, polysk: 0.55 },
  dekton: { base: '#cfd0d1', base2: '#bfc0c2', vein: '#a2a3a6', freqX: 0.55, freqY: 0.55, octaves: 2, kontrast: 0.28, polysk: 0.6 },
  trawertyn: { base: '#d8c6a6', base2: '#cbb790', vein: '#a98f66', freqX: 0.05, freqY: 0.55, octaves: 3, kontrast: 0.5, polysk: 0.25 },
  onyks: { base: '#e2d3ab', base2: '#d0bd8b', vein: '#a98a52', freqX: 0.008, freqY: 0.06, octaves: 4, kontrast: 0.6, polysk: 0.7 },
  usluga: { base: '#e8e8e8', base2: '#dcdcdc', vein: '#c4c4c4', freqX: 0.8, freqY: 0.8, octaves: 2, kontrast: 0.2, polysk: 0.3 },
  akcesorium: { base: '#e8e8e8', base2: '#dcdcdc', vein: '#c4c4c4', freqX: 0.8, freqY: 0.8, octaves: 2, kontrast: 0.2, polysk: 0.3 },
}
